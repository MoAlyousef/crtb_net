...
# For static linking
# g++-9 -std=c++17 -c -I../include -I../.ext/rtb/include -o ../bin/crtb_net.o ../libsrc/crtb_net.cpp
# ar -crs ../bin/libcrtb_net.a ../bin/crtb_net.o
# gcc-9 -std=c89 -I../include -o ../bin/main main.c ../bin/libcrtb_net.a -lstdc++ -pthread
...
# g++-9 -std=c++17 -c -I../include -I../.ext/rtb/include -o ../bin/crtb_net.o ../libsrc/crtb_net.cpp
# ar -crs ../bin/libcrtb_net.a ../bin/crtb_net.o
# gcc-9 -std=c89 -I../include -o ../bin/main main.c ../bin/libcrtb_net.a -lstdc++ -lssl -lcrypto -pthread
