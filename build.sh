...
# g++-9.exe -std=c++17 -DWIN32_LEAN_AND_MEAN -c -Iinclude -Iext/rtb/include -o bin/crtb_net.o libsrc/rtb_net.cpp -fPIC
...
# g++-9 -std=c++17 -c -Iinclude -Iext/rtb/include -o bin/crtb_net.o libsrc/crtb_net.cpp -fPIC
